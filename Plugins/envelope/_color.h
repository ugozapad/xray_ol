...
public:
	...
	IC	DWORD	get( ) const
	{
		DWORD _r = uROUND(r*255.f); clamp(_r,0ul,255ul);
		DWORD _g = uROUND(g*255.f); clamp(_g,0ul,255ul);
		DWORD _b = uROUND(b*255.f); clamp(_b,0ul,255ul);
		DWORD _a = uROUND(a*255.f); clamp(_a,0ul,255ul);
